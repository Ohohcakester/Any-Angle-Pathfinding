...
public class StrictVisibilityGraphAlgorithm extends AStar {
    
    private IncrementalVisibilityGraph visibilityGraph;
    private float pathLength;

    public StrictVisibilityGraphAlgorithm(GridGraph graph, int sx, int sy,
            int ex, int ey) {
    ...
    public void computePath() {
        ...
        visibilityGraph = new IncrementalVisibilityGraph(graph, sx, sy, ex, ey, pathLength);
    ...
    private boolean tryRelax(int curr, int currX, int currY, int dest) {        
        ...
        float sldCurrDest = graph.distance(currX, currY, pDest.x, pDest.y);
        float sldDestGoal = graph.distance(pDest.x, pDest.y, ex, ey);
        if (sldCurrDest + sldDestGoal > remainingDistance + BUFFER) return false;
        ...
        if (relax(curr, dest, sldCurrDest)) {
