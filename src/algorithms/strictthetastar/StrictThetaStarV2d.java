 ...
 *
 */
public class StrictThetaStarV2d extends BasicThetaStar {
    private static final int DEPTH_LIMIT = -1;
    private static final float BUFFER_VALUE = 1f; // 0.33f is enough.

    public StrictThetaStarV2d(GridGraph graph, int sx, int sy, int ex, int ey) {
        super(graph, sx, sy, ex, ey);
    }
    
    public static StrictThetaStarV2d noHeuristic(GridGraph graph, int sx, int sy, int ex, int ey) {
        StrictThetaStarV2d algo = new StrictThetaStarV2d(graph, sx, sy, ex, ey);
