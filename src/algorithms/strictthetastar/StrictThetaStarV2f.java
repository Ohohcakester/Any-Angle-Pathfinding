 ...
 * V2f: Non-recursive version for comp with theta*
 * @author Oh
 * 
 * Ideas:
 * Heuristic trap:
 ...
 *
 */
public class StrictThetaStarV2f extends BasicThetaStar {
    private int DEPTH_LIMIT = -1;
    private static final float BUFFER_VALUE = 0.36f; // 0.33f is enough.

    public StrictThetaStarV2f(GridGraph graph, int sx, int sy, int ex, int ey) {
        super(graph, sx, sy, ex, ey);
    }
    
    public static StrictThetaStarV2f noHeuristic(GridGraph graph, int sx, int sy, int ex, int ey) {
        StrictThetaStarV2f algo = new StrictThetaStarV2f(graph, sx, sy, ex, ey);
        algo.heuristicWeight = 0f;
        return algo;
    }
    
    public static StrictThetaStarV2f depthLimit(GridGraph graph, int sx, int sy, int ex, int ey, int depthLimit) {
        StrictThetaStarV2f algo = new StrictThetaStarV2f(graph, sx, sy, ex, ey);
